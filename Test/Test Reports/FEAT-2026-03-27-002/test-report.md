...
**Then:**
- ✅ System compares only SKILL.md hash (skill-level strategy)
- ✅ SKILL.md hash matches → entire skill skipped
- ✅ No file writes occurred
- ✅ Resource added to `skipped_resources`

**Result:** PASSED

**Improvement Note (v2.1.1):**
- Changed from per-file hash comparison to SKILL.md-only comparison
- Prevents file addition/deletion detection issues
- Atomic update: skip all or download all
...
- Remote SKILL.md updated (version bump)

**When:**
- `sync_resources` detects SKILL.md hash mismatch

**Then:**
- ✅ SKILL.md changed → triggers full skill re-download
- ✅ All 3 script files re-written
- ✅ Ensures complete consistency

**Result:** PASSED

**Rationale:**
- SKILL.md is the version manifest for entire skill
- Any script change should be reflected in SKILL.md
- Prevents orphaned or missing files
